...
| # | Issue | Complexity/Impact | Location | Diff line |
|---|-------|-------------------|----------|-----------|
| 1 | Description | O(n²) → O(n) | link to specific line in file | 42 |
| 2 | Description | +50ms latency | link to specific line in file | 55 |
